...
export const metadata: Metadata = {
  title: "StartDown - Intelligent Investment Platform for Modern Investors",
  description: "Grow your wealth with StartDown's AI-powered investment platform. Professional portfolio management, real-time analytics, and transparent pricing for beginners and experts.",
  keywords: ["investment platform", "portfolio management", "AI investing", "wealth management", "investment app", "stock market"],
  metadataBase: new URL("https://startdown.io"),
  alternates: {
    canonical: "https://startdown.io"
  },
  openGraph: {
    title: "StartDown - Smart Investment Solutions",
    description: "Intelligent portfolio management and real-time market analytics for sustainable wealth growth.",
    url: "https://startdown.io",
    siteName: "StartDown",
    type: "website",
    images: [
      {
        url: "https://img.b2bpic.net/free-vector/user-panel-template-infographic-dashboard_23-2148378206.jpg",
        alt: "StartDown Investment Platform"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "StartDown - Intelligent Investment Platform",
    description: "Grow your wealth with AI-powered portfolio management and real-time analytics.",
    images: ["https://img.b2bpic.net/free-vector/user-panel-template-infographic-dashboard_23-2148378206.jpg"]
  },
  robots: {
    index: true,
    follow: true
